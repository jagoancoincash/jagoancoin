...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.jagoancoin.online");
        vSeeds.emplace_back("dnsseed2.jagoancoin.online");
        vSeeds.emplace_back("dnsseed3.jagoancoin.online");
        vSeeds.emplace_back("dnsseed4.jagoancoin.online");
        vSeeds.emplace_back("dnsseed5.jagoancoin.online");
        vSeeds.emplace_back("dnsseed6.jagoancoin.online");
        vSeeds.emplace_back("dnsseed7.jagoancoin.online");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("seed00.jagoancoin.online");
        vSeeds.emplace_back("seed01.jagoancoin.online");
        vSeeds.emplace_back("seed02.jagoancoin.online");
        vSeeds.emplace_back("seed03.jagoancoin.online");
        vSeeds.emplace_back("seed04.jagoancoin.online");
