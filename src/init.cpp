...
public:
    ...
    // Jagoancoin Specific WalletInitInterface InitCoinJoinSettings
 ...
 * between jagoancoind, and jagoancoin-qt and non-server tools.
*/
...
void PrepareShutdown()
{
    ...
    RenameThread("jagoancoin-shutoff");
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<jagoancoinaddress>", "Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.", false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by Jagoancoin Platform, to the specified username.", false, OptionsCategory::SMARTNODE);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jagoancoincash/jagoancoin>";
    const std::string URL_WEBSITE = "<https://www.jagoancoin.online>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("jagoancoin-loadblk");
...
/** Sanity checks
 *  Ensure that Jagoancoin Core is running in a usable environment with all
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 10c: schedule Jagoancoin-specific tasks
